...
Additionally the subject identifier (1-30) and the activity being performed are included.

## Data Source

The data was taken from http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones and downloaded from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip as a project for Johns Hopkins' Getting and Cleaning Data Course.
...
That data was merged to include the subject and activity identifier along with the various data collected. 

The following variables were removed from the set of variables:\
